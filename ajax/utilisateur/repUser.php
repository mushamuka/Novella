<?php 
                            ...
                            <tr>
                                ...
                                <td><?php echo $value->heure_debut/*$value->heure_fin*/?></td>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control"id="cate<?=$i?>" class="form-control" value="<?php echo $value->nom_categorie?>" desabled>
                                                        <?php
                                                        $i =0;
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <div class="input-group-prepend"><span class="input-group-text"></span></div>
                                                    <input type="text" id="hdebut<?=$i?>" class="form-control" value="<?php echo $value->heure_debut?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <div class="input-group-prepend"><span class="input-group-text"></span></div>
                                                   <input type="text" class="form-control" id="hfin<?=$i?>" value="<?php echo $value->heure_fin?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
