...
class myPDF extends FPDF
{
	...
	*/
	...
	function header()
	{
		...
		$this->Cell(60,5,'VENTE JOURNALIERE',0,1,'C');
	...
	function viewTable($vente,$ventejour)
	{
		...
		foreach ($vente->getvente_journaliere($ventejour) as $value) 
		{
