...
class myPDF extends FPDF
{
	...
	*/
	...
	function header()
	{
		...
		$this->Cell(40,5,' HISTORICK STOCK ',0,1,'C');
	...
	function headerTable()
	{
		...
		$this->Cell(13,8,'#histo',1,0,'C',1);
		$this->Cell(30,8,'Date creation',1,0,'C',1);
		$this->Cell(30,8,'LIBELLE',1,0,'C',1);
		$this->Cell(20,8,'Article',1,0,'C',1);
		$this->Cell(18,8,'Quantite',1,0,'C',1);
	
		$this->Cell(50,8,'Commentaire',1,1,'C',1);
	...
	function viewTable($stock,$cond)
	{
		...
		foreach ($stock->filtre_stockboison($cond) as $value)  
		{ $i++;
			$this->Cell(13,8,$value->ID_histo,1,0);

			$this->Cell(30,8,$value->date_stock,1,0);
			$this->Cell(30,8,$value->LIBELLE,1,0);
			$this->Cell(20,8,$value->ARTICLE,1,0);
			$this->Cell(18,8,$value->quantite,1,0);
			$this->Cell(50,8,$value->description,1,1);
		}
